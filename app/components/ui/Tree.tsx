...
const itemStyles = tv({
	extend: focusRing,
	base: "group relative flex cursor-default select-none gap-3 border-transparent border-t bg-white px-3 py-1 font-sans text-neutral-900 text-sm -outline-offset-2 first:rounded-t-lg first:border-t-0 last:rounded-b-lg dark:border-t-neutral-700 dark:bg-neutral-900 dark:text-neutral-200",
	variants: {
		isSelected: {
			false:
				"pressed:bg-neutral-100 hover:bg-neutral-100 dark:pressed:bg-neutral-800 dark:hover:bg-neutral-800",
